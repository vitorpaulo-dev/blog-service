	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationConverter jwtAuthenticationConverter) throws Exception {
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.GET, "/v1/reactions/**").permitAll()
				.requestMatchers(HttpMethod.POST, "/v1/reactions/**").permitAll()
				.requestMatchers(HttpMethod.DELETE, "/v1/reactions/**").permitAll()
				.requestMatchers(HttpMethod.GET, "/v1/post/slug/**").permitAll()
				.requestMatchers(HttpMethod.GET, "/v1/post").permitAll()
