...
ALTER TABLE project ALTER COLUMN love_count SET DEFAULT 0;
ALTER TABLE project ALTER COLUMN celebrate_count SET DEFAULT 0;
ALTER TABLE project ALTER COLUMN genius_count SET DEFAULT 0;
ALTER TABLE project ALTER COLUMN help_count SET DEFAULT 0;
